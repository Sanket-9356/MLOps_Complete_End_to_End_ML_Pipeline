...
def transform_text(text):
    """Transforms the input text by converting it to lowercase, tokenization , removing stopwords and punctuation and stemming"""
    ps=PorterStemmer()
    ...
    # Removing non_alphanumeric tokens
...
def preprocess_df(df,text_column='text',target_column ='target'):
    ...
    try:
        logger.debug('Staring Preprocessing for DataFrame')
        ...
        # Apply text transformation to specilized text column
